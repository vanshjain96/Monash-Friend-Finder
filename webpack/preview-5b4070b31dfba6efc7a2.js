...
return m.default.createElement(O,{key:r,src:a,name:t,currentArtboardId:c,id:r,imageSet:i,artboardId:n,requestLayer:o.requestLayer,activeLayer:o.handleActiveLayer,activeLayerId:l})}),m.default.createElement(j,{onClick:this.downloadSlice,isLoading:t,isLogin:s}))}}]),a}(m.PureComponent)
M.propTypes={slicesMap:h.default.array.isRequired,loading:h.default.bool,error:h.default.bool,currentArtboardId:h.default.string,isLogin:h.default.bool,projectCid:h.default.string,projectName:h.default.string,dispatch:h.default.func}
var O=function(e){function t(){var n
...
return{slicesMap:i,loading:o,error:l,isLogin:!!n.id,projectCid:r,currentArtboardId:c.artboard_id}})(M)
